...
exports['default'] = _react2['default'].createClass({
  ...
  componentDidUpdate: function componentDidUpdate() {
    ...
    this.timeout = setTimeout(this._hideFlippedSide, 600);
  },
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'div',
        {
          ...
          id: 'ReactFlipCard__Flipper' + this.props.index.toString(),
          style: {
            width: '100%',
            height: '100%'
          },
  ...
  _hideFlippedSide: function _hideFlippedSide() {
    ...
    if (this.props.disabled) {
      if (this.state.isFlipped && this.refs.front) {
        this.refs.front.style.display = 'none';
      } else if (!this.state.isFlipped && this.refs.back) {
